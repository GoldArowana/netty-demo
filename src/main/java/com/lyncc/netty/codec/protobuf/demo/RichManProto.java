...
public final class RichManProto {
    ...
    // @@protoc_insertion_point(interface_extends:netty.RichMan)
         ...
         */
        java.util.List<RichMan.Car> getCarsList();
         ...
         * <code>repeated .netty.RichMan.Car cars = 4;</code>
         */
        java.util.List<? extends RichMan.CarOrBuilder> getCarsOrBuilderList();
    ...
    // @@protoc_insertion_point(message_implements:netty.RichMan)
         ...
         * <code>repeated .netty.RichMan.Car cars = 4;</code>
         */
        public java.util.List<? extends CarOrBuilder> getCarsOrBuilderList() {
            return cars_;
        }
        ...
        // @@protoc_insertion_point(builder_implements:netty.RichMan)
            ...
            private java.util.List<Car> cars_ = java.util.Collections
                    .emptyList();
             ...
             * <code>repeated .netty.RichMan.Car cars = 4;</code>
             */
            public java.util.List<Car.Builder> getCarsBuilderList() {
